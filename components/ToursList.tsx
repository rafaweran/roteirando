                ...
                <div className="flex flex-wrap gap-2">
                  {STATUS_OPTIONS.map((option) => (
                    <button
                      ...
                      `}
                    >
                      {filters.status === option.value && <CheckCircle2 size={14} />}
                      {option.label}
                    </button>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="date"
                      className="w-full h-10 pl-10 pr-3 rounded-lg border border-border text-sm text-text-primary focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
                      value={filters.date}
                   ...
                   <div className="flex items-center gap-2">
                      <div className="relative flex-1">
                        ...
                        <input 
                          ...
                          placeholder="Mín"
                          min="0"
                          className="w-full h-10 pl-8 pr-3 rounded-lg border border-border text-sm focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none"
