...
-- Tour Links table (for links associated with tours or trips)
...
CREATE TABLE IF NOT EXISTS groups (
  ...
  leader_password VARCHAR(255),
  password_changed BOOLEAN DEFAULT FALSE,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);

-- Tour Attendance table (many-to-many relationship between groups and tours)
...
-- Policy: Allow all operations for authenticated users (you can customize this later)
...
-- Policy: Allow public read access (you can remove this if you want full authentication)
