/**
 * Script para executar SQL diretamente no Supabase via REST API
...
async function executeSQL() {
  ...
  try {
    // O Supabase não permite executar SQL DDL via REST API com anon key
    // Precisamos usar o SQL Editor do dashboard ou a service_role key
    console.log('⚠️  O Supabase não permite executar SQL DDL via API REST com a chave anon.');
    ...
    console.log('2. Cole o SQL abaixo no editor');
    console.log('3. Clique em "Run" (ou Cmd+Enter)\n');
