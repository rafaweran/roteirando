...
const Layout: React.FC<LayoutProps> = ({ children, onLogout, onNavigateHome, onNavigateTours, onNavigateGroups }) => {
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-3 pl-4 border-l border-border">
              <div className="text-right hidden lg:block">
                <p className="text-sm font-semibold text-text-primary leading-none">Admin User</p>
                <p className="text-xs text-text-secondary mt-1">admin@travel.com</p>
              </div>
            ...
            <div className="p-4 border-t border-border mt-auto">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-secondary">admin@travel.com</p>
                </div>
              </div>
              <button 
                onClick={onLogout}
